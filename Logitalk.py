...
class MainWindow(CTk):
   def __init__(self):
       ...
       self.adaptive_ui()
       self.add_message("Демонстрація відображення зображення:", CTkImage(Image.open('sprte2.png'), size=(300, 300)))
       try:
           self.sock = socket(AF_INET, SOCK_STREAM)
           self.sock.connect(('4.tcp.eu.ngrok.io', 11457)) #correct
